...
public class SignIn {
	...
	public static HBox display(String current) throws IOException
	{
		...
		emailField.setStyle("-fx-background-color: -fx-text-box-border , -fx-background; -fx-background-insets: 0, 0 0 1 0 ;-fx-background-radius: 0 ;");
		...
		//passwordField.setStyle("-fx-background-image:url('logo.png'); -fx-background-repeat: no-repeat; -fx-background-position: right center; -fx-font-size: 20");
		passwordField.setStyle("-fx-background-color: -fx-text-box-border , -fx-background; -fx-background-insets: 0, 0 0 1 0 ;-fx-background-radius: 0 ;");
		...
		loginBtn.setStyle(" -fx-text-fill:white ; -fx-background-radius: 20, 1, 4, 10; -fx-pref-height: 38px; -fx-pref-width: 200px; -fx-background-color:#485D7A");
